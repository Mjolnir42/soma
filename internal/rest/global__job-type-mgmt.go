...
func (x *Rest) JobTypeMgmtList(w http.ResponseWriter, r *http.Request,
...
func (x *Rest) JobTypeMgmtShow(w http.ResponseWriter, r *http.Request,
	params httprouter.Params) {
	defer panicCatcher(w)
...
func (x *Rest) JobTypeMgmtAdd(w http.ResponseWriter, r *http.Request,
	params httprouter.Params) {
	defer panicCatcher(w)
...
func (x *Rest) JobTypeMgmtRemove(w http.ResponseWriter, r *http.Request,
	params httprouter.Params) {
	defer panicCatcher(w)
...
func (x *Rest) JobTypeMgmtSearch(w http.ResponseWriter, r *http.Request,
	params httprouter.Params) {
	defer panicCatcher(w)
